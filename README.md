...
POR HACER :/
AL momento de generar la tarjeta hay fecha de expiracion que esta es un año

TAREAS DIEGO
[] AGREGAR LA COLUMNA(ID TARJETA) EN MOSTRAR APRENDICES Y FUNCIONARIOS 
[] AGREGAR LA COLUMNA(ID TARJETA) EN EL PANEL DE BUSCAR USUARIO.
